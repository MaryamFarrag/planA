...
@Component({
  selector: 'app-show-work-place',
  templateUrl: './show-work-place.component.html',
  styleUrls: ['./show-work-place.component.scss']
})
export class ShowWorkPlaceComponent implements OnInit {
 weddings:  wedding[];
  index: any;
